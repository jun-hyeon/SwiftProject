...
class MyTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.carImageView?.image = UIImage(named: cars[indexPath.row].imageName)
        
        cell.carLabel?.text = cars[indexPath.row].name
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "CarDetail"{
            ...
            let detailview = segue.destination as! CarDetailViewController
            let row = self.tableView.indexPathForSelectedRow!.row
            detailview.car = cars[row]
        }
